      ...
      <section className="bg-[#F9F6F0] py-16 lg:py-24 border-t border-[#E8DFD0]">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="font-[family-name:var(--font-heading)] text-2xl md:text-3xl font-semibold text-[#1A1A1A] mb-6">
              Our Story
            </h2>
            ...
            {/* Pull quote */}
            <blockquote className="my-8 border-l-4 border-[#E8813A] pl-6 py-2">
              <p className="text-xl text-[#1A1A1A] italic font-[family-name:var(--font-heading)] leading-relaxed">
